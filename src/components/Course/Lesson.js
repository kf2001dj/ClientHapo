                ...
                {selectedOption === "lessons" && (
                  <>
                    ...
                    <p className="txtdes-less-viv">
                      ...
                      fringilla tempus. Vivamus bibendum nibh in dolor pharetra,
                      a euismod nulla dignissim. Aenean viverra tincidunt nibh,
                      in imperdiet nunc. Suspendisse eu ante pretium,
                      consectetur leo at, congue quam. Nullam hendrerit porta
                      ante vitae tristique. Vestibulum ante ipsum primis in
                      faucibus orci luctus et ultrices posuere cubilia Curae;
                      Vestibulum ligula libero, feugiat faucibus mattis eget,
                      pulvinar et ligula.
                    </p>
                    <>
                      ...
                      <p className="txtdes-less-viv">
                        ...
                        rutrum. Nam nulla ipsum, venenatis malesuada felis quis,
                        ultricies convallis neque. Pellentesque tristique
                        fringilla tempus. Vivamus bibendum nibh in dolor
                        pharetra, a euismod nulla dignissim. Aenean viverra
                        tincidunt nibh, in imperdiet nunc. Suspendisse eu ante
                        pretium, consectetur leo at, congue quam. Nullam
                        hendrerit porta ante vitae tristique. Vestibulum ante
                    ...
                    <a href="/##" type="button" className="next-learn-foot">
                      <p>#learn</p>
                    </a>
                    <a href="/##" type="button" className="nexxt-html">
                      <p>#html</p>
                    </a>
                    <a href="/##" type="button" className="nexxt-css">
                      <p>#css</p>
                    </a>
                    <a href="/##" type="button" className="nexxt-coder">
                      <p>#coder</p>
                    </a>
                    <a href="/##" type="button" className="nexxt-developer">
                      <p>#developer</p>
                    </a>
                    <a href="/##" type="button" className="nexxt-js">
                      <p>#js</p>
                    </a>
                  </>
                )}
